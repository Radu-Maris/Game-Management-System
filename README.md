A java desktop application meant to track how many hours the user spends in each game. The app was developed using Java and PostgreSQL for database storage.
